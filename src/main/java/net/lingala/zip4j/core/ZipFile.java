...
import net.lingala.zip4j.unzip.UnzipNameFilter;
...
public class ZipFile {
	...
	public void extractAll(String destPath, 
        ...
        public void extractAllSatisfying(String destPath, UnzipNameFilter filter) throws ZipException {
            if (!Zip4jUtil.isStringNotNullAndNotEmpty(destPath)) {
			throw new ZipException("output path is null or invalid");
		}
		...
		Unzip unzip = new Unzip(zipModel);
		unzip.extractAllSatisfying(filter, null, destPath, progressMonitor, runInThread);
        }
